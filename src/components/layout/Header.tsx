    ...
    <header className="sticky top-0 z-50 border-b border-inkwash bg-paper/95 backdrop-blur-sm">
      <nav className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4">
        ...
        <div className="flex items-center gap-4 text-sm">
          <Link href="/" className="text-zinc-600 transition-colors hover:text-ink dark:text-zinc-400 dark:hover:text-ink">
            首页
          </Link>
          <Link href="/search" className="text-zinc-600 transition-colors hover:text-ink dark:text-zinc-400 dark:hover:text-ink">
            搜索
          </Link>
          <button
            onClick={toggle}
